...
def adaBoostTrainDS(dataArr,classLabels,numIt=40):
    ...
    for i in range(numIt):
        ...
        aggErrors = multiply(sign(aggClassEst) != mat(classLabels).T,ones((m,1))) #too good!!! transform true/false into 1/0
...
errorNum = errArr[prediciton10 != mat(testLabelArr).T].sum()
print errorNum/67.0